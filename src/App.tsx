...
function AppRouter() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-muted-foreground text-sm font-medium">Carregando Nexus TCMS...</div>
      </div>
    );
  }
  ...
  const suspenseFallback = (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-muted-foreground text-sm font-medium">Carregando página...</div>
    </div>
  );
    ...
    <Suspense fallback={suspenseFallback}>
      <Routes>
        ...
        <Route element={<AuthGuard><Layout /></AuthGuard>}>
          ...
          {/* Gestão da Qualidade com abas integradas */}
          <Route 
            path="/management" 
            element={
          ...
          {/* Rotas antigas redirecionam para Gestão com a respectiva aba */}
