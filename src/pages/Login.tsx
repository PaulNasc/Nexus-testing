      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-6">
          <div className="flex flex-col items-center justify-center mb-2">
            <div className="h-16 w-16 rounded-2xl bg-card border border-border/80 p-2 flex items-center justify-center mb-3 shadow-lg shadow-black/20 backdrop-blur-sm">
              <NexusIcon size={48} className="w-12 h-12" />
            </div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">Nexus Testing</h1>
            <p className="text-xs text-muted-foreground mt-1">Plataforma de Gestão de Casos e Qualidade</p>
          </div>
        </div>
